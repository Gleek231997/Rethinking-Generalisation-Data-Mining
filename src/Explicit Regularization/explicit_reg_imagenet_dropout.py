  ...
  for epoch in range(start_epoch, epochs):  
    ...
    for i, data in enumerate(train_loader, 0):
      ...
      if step_count % 10000 == 0:
        ...
        with open("model_2_new.log", "a") as f:
          f.write(log_entry)
...
optimizer = torch.optim.SGD(inception_model.parameters(), lr=0.1, momentum=0.9)
scheduler = torch.optim.lr_scheduler.StepLR(optimizer, 1, gamma=1.0)

resume_training = True  # Modify this according to your requirements

if resume_training:
    checkpoint = torch.load('/Users/shubham/Documents/Rutgers University/MS in Data Science/Spring 2024/Financial Data Mining/Project/')
